...
@widgets.register
class JsonEditor(widgets.DOMWidget):
    """Progressivis JsonEditor widget."""

    # Name of the widget view class in front-end
    _view_name = Unicode("JsonEditorView").tag(sync=True)

    # Name of the widget model class in front-end
    _model_name = Unicode("JsonEditorModel").tag(sync=True)
